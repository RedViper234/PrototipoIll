...
public class EditorRoomData : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(priorita, new GUIContent("Priorit�"), true);
        EditorGUILayout.PropertyField(isFirstRoom, new GUIContent("� la prima stanza?"), true);
        EditorGUILayout.PropertyField(raritaEValoreStanza, new GUIContent("Rarit� e valore:"), true);
        DrawUILine(Color.gray, 1);
