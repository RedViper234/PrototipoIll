...
public class Mortality : MalattiaStat
{
    ...
    public void timeIllVulnerabilityOrResistance(MalattiaHandler handler)
    {
        ...
        float value = Mathf.RoundToInt(illResistance.y - ((range / 100) * actualValue)); //si usa y- perchË il rapporto Ë inversamente proporzionale (all'aumentare della barra peggiora il value)
