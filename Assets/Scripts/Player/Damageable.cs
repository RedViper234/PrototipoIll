...
public class Damageable : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (GetComponent<PlayerController>()) //se � il player lascio che sia la statistica ad impostare la vita
        {
            maxHealth = 0;
            currentHealth = 0;
    ...
    {
        // Se una coroutine di guarigione � gi� in esecuzione, la interrompiamo.
